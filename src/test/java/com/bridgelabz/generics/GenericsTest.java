...
class GenericsTest {
    ...
    void IntegerTestCase1() {
        ...
        int output = runner.maximum(7,5,3); // max number at 1st position
        assertEquals(7,output);
    }
    @Test
    void IntegerTestCase2() {
        Generics runner = new Generics();
        int output = runner.maximum(4,8,3); // max number at 2nd postion
        assertEquals(8,output);
    }
    @Test
    void IntegerTestCase3() {
        Generics runner = new Generics();
        int output = runner.maximum(7,2,9); // max number at 3rd position
    ...
    void testCase2_1() {
        Generics runner = new Generics();
        float output = runner.maximum(12.3f,2.1f,9.3f);// max float at 1st position
        assertEquals(12.3f,output);
    }
    @Test
    void testCase2_2() {
        Generics runner = new Generics();
        float output = runner.maximum(14.2f,27.9f,7.2f);// max float at 2nd position
        assertEquals(27.9f,output);
    }
    @Test
    void testCase2_3() {
        Generics runner = new Generics();
        float output = runner.maximum(11.7f,4.2f,18.5f);// max float at 3rd position.
